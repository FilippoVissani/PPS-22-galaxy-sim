...
object CollisionInstances:
  given IntToIntCollision : Collision[Int, Int] =
    Collision.from[Int, Int](_ == _)(_ + _)

  given CircleToCircleCollision: Collision[CircleCollisionBox, CircleCollisionBox] =
    Collision.from[CircleCollisionBox, CircleCollisionBox]((c1, c2) => {
